...
func (mu *MessageUpdate) SetFrom(s string) *MessageUpdate {
...
func (mu *MessageUpdate) SetCtreatedAt(t time.Time) *MessageUpdate {
	mu.mutation.SetCtreatedAt(t)
	return mu
}

// SetNillableCtreatedAt sets the "ctreated_at" field if the given value is not nil.
func (mu *MessageUpdate) SetNillableCtreatedAt(t *time.Time) *MessageUpdate {
	if t != nil {
		mu.SetCtreatedAt(*t)
	}
	return mu
...
func (mu *MessageUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := mu.mutation.CtreatedAt(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeTime,
			Value:  value,
			Column: message.FieldCtreatedAt,
		})
	}
...
// SetFrom sets the "from" field.
func (muo *MessageUpdateOne) SetFrom(s string) *MessageUpdateOne {
...
// SetCtreatedAt sets the "ctreated_at" field.
func (muo *MessageUpdateOne) SetCtreatedAt(t time.Time) *MessageUpdateOne {
	muo.mutation.SetCtreatedAt(t)
	return muo
}

// SetNillableCtreatedAt sets the "ctreated_at" field if the given value is not nil.
func (muo *MessageUpdateOne) SetNillableCtreatedAt(t *time.Time) *MessageUpdateOne {
	if t != nil {
		muo.SetCtreatedAt(*t)
	}
	return muo
...
func (muo *MessageUpdateOne) sqlSave(ctx context.Context) (_node *Message, err error) {
	...
	if value, ok := muo.mutation.CtreatedAt(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeTime,
			Value:  value,
			Column: message.FieldCtreatedAt,
