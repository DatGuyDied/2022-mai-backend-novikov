...
func (mc *MessageCreate) SetFrom(s string) *MessageCreate {
...
func (mc *MessageCreate) SetCtreatedAt(t time.Time) *MessageCreate {
	mc.mutation.SetCtreatedAt(t)
	return mc
}

// SetNillableCtreatedAt sets the "ctreated_at" field if the given value is not nil.
func (mc *MessageCreate) SetNillableCtreatedAt(t *time.Time) *MessageCreate {
	if t != nil {
		mc.SetCtreatedAt(*t)
	}
	return mc
...
func (mc *MessageCreate) defaults() {
	if _, ok := mc.mutation.CtreatedAt(); !ok {
		v := message.DefaultCtreatedAt()
		mc.mutation.SetCtreatedAt(v)
	}
}
...
func (mc *MessageCreate) check() error {
	...
	if _, ok := mc.mutation.CtreatedAt(); !ok {
		return &ValidationError{Name: "ctreated_at", err: errors.New(`ent: missing required field "Message.ctreated_at"`)}
	}
	return nil
}
...
func (mc *MessageCreate) createSpec() (*Message, *sqlgraph.CreateSpec) {
	...
	if value, ok := mc.mutation.CtreatedAt(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeTime,
			Value:  value,
